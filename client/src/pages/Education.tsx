      ...
      <nav className="sticky top-0 z-50 bg-background/80 backdrop-blur-md border-b border-border/50">
        <div className="max-w-7xl mx-auto container px-4 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium">
            ...
            <Link href="/education" className="hover:text-primary transition-colors text-primary font-bold">Education</Link>
        ...
        <AnimatePresence>
          ...
          <div className="max-w-7xl mx-auto container px-4 py-6 flex flex-col gap-4 text-lg font-medium">
                ...
                <Link href="/education" className="text-primary font-bold" onClick={() => setIsMenuOpen(false)}>Education</Link>
